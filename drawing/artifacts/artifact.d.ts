...
export type SldArtifactContext = {
    ...
    renderLabel(element: Element, options?: {
        preview?: boolean;
...
export type SldArtifactDescriptor<TState, TActions> = {
    actions(element: Element, context: SldArtifactContext, state: TState): TActions;
    matches(element: Element): boolean;
    render(element: Element, state: TState, actions: TActions, context: SldArtifactContext, options?: ArtifactRenderOptions): SVGTemplateResult;
    state(element: Element, context: SldArtifactContext, options?: ArtifactRenderOptions): TState | undefined;
};
