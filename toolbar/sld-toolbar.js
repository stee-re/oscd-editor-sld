...
const aboutContent = await fetch(new URL('../about.html', import.meta.url)).then(res => res.text());
...
function newStartPlacingEvent(element) {
...
export class SldToolbar extends ScopedElementsMixin(LitElement) {
    ...
    // --- Helpers ---
    get hasSubstation() {
        return !!Array.from(this.doc.documentElement.children).find(c => c.tagName === 'Substation');
    }
    get hasVoltageLevel() {
        return !!this.doc.querySelector(':root > Substation > VoltageLevel');
    }
    get hasBay() {
        return !!Array.from(this.doc.querySelectorAll(':root > Substation > VoltageLevel > Bay')).find(bay => !isBusBar(bay));
    }
    get hasIeds() {
    ...
    renderEquipmentFabs() {
        ...
        return eqTypes.map(eqType => html `<oscd-fab
          size="small"
    ...
    renderTransformerFabs() {
        if (!this.hasSubstation) {
            return nothing;
        }
        return transformerConfigs.map(config => html `<oscd-fab
          size="small"
    ...
    renderViewControls() {
      ...
      >
        ...
        if (this.doc.querySelector('Substation')) {
          ...
          @click=${() => this.dispatchEvent(new CustomEvent('zoom', {
                bubbles: true,
                composed: true,
                detail: { direction: 'in' },
            }))}
...
__decorate([
    query('#about')
], SldToolbar.prototype, "aboutDialog", void 0);
__decorate([
    property({ type: Object })
], SldToolbar.prototype, "doc", void 0);
__decorate([
    property({ type: Number })
], SldToolbar.prototype, "docVersion", void 0);
__decorate([
    property({ type: String })
], SldToolbar.prototype, "nsp", void 0);
__decorate([
    property({ type: Object })
], SldToolbar.prototype, "templateElements", void 0);
__decorate([
    property({ type: Boolean })
], SldToolbar.prototype, "inAction", void 0);
__decorate([
    property({ type: Number })
], SldToolbar.prototype, "gridSize", void 0);
__decorate([
    state()
], SldToolbar.prototype, "_showIeds", void 0);
__decorate([
    state()
], SldToolbar.prototype, "_showLabels", void 0);
//# sourceMappingURL=sld-toolbar.js.map