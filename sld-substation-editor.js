...
import { resizeBRPath, resizePath, resizeTLPath, symbols, zigZag2WTransform, zigZagPath, } from './drawing/diagram-symbols.js';
import { conductingEquipmentArtifact, } from './drawing/artifacts/conducting-equipment.js';
import { iedReferenceArtifact, } from './drawing/artifacts/ied-reference.js';
import { cleanPath, distance, findIntersection, } from './foundations/geometry.js';
...
import { copyElementForPlacement, createGroundTerminalEdits, } from './foundations/edits.js';
import { connectionStartPoints, isBusBar } from './foundations/connectivity.js';
import { attributes, getSLDAttributes, updateSLDAttributes, xmlBoolean, } from './foundations/sld-attributes.js';
...
import { newConnectEvent, newEditIedEvent, newPlaceEvent, newPlaceLabelEvent, newResizeEvent, newResizeTLEvent, newRotateEvent, newSclEditDialogEvent, newSelectEvent, newStartConnectEvent, newStartPlaceEvent, newStartPlaceLabelEvent, newStartResizeBREvent, newStartResizeTLEvent, } from './foundations/events.js';
...
export class SldSubstationEditor extends ScopedElementsMixin(LitElement) {
    ...
    contextMenuContext(element, e) {
        const [gridX, gridY] = e.clientX || e.clientY
    ...
    render() {
      ...
      />`
        ...
        if (this.resizingTL) {
            ...
            hidden = false;
            invalid = !canResizeToTL(this.substation, this.resizingTL, newX, newY, newW, newH);
            coordinates = html `${newW}&times;${newH}`;
        }
      ...
      <oscd-dialog id="resizeSubstationUI">
        ...
        >
          <oscd-outlined-text-field
            ...
            if (validity.valid &&
                !canResizeTo(this.substation, this.substation, parseInt(value, 10), oldH)) {
          ...
          <oscd-outlined-text-field
            ...
            if (validity.valid &&
                !canResizeTo(this.substation, this.substation, oldW, parseInt(value, 10))) {
                return { valid: false, rangeUnderflow: true };
            }
            return {};
        }}
        ...
        <div slot="actions">
          ...
          <oscd-text-button
            @click=${() => {
            const valid = Array.from(this.resizeSubstationUI.querySelectorAll('oscd-outlined-text-field')).every(textField => textField.checkValidity());
            if (!valid) {
                return;
            }
    ...
    renderContainer(bayOrVL, preview = false) {
        ...
        let handleClick = (e) => {
            if (this.idle) {
                this.dispatchEvent(newStartPlaceEvent(e.shiftKey ? copyElementForPlacement(bayOrVL, this.nsp) : bayOrVL, offset));
            }
        };
        let invalid = false;
        let contextmenu = (e) => {
    ...
    renderTransformerWinding(winding) {
        const { size, center: [cx, cy], terminals, grounded, arc, zigZagTransform, } = transformerWindingMeasures(winding, this.renderedPosition(winding.parentElement), attributes(winding.parentElement), zigZag2WTransform);
        const ports = [];
    ...
    artifactContext() {
        return {
            ...
            groundTerminal: (element, terminal) => this.groundTerminal(element, terminal),
            ...
            nsp: this.nsp,
            openContextMenu: (element, event) => this.contextMenu?.open(this.contextMenuContext(element, event)),
            ...
            resolveIedName: referencedIed => this.resolvedIed(referencedIed)?.getAttribute('name') ?? null,
    ...
    renderArtifact(descriptor, element, options = {}) {
        ...
        return descriptor.render(element, state, descriptor.actions(element, context, state), context, options);
    }
    renderEquipment(equipment, options = {}) {
...
__decorate([
    property()
], SldSubstationEditor.prototype, "doc", void 0);
__decorate([
    property()
], SldSubstationEditor.prototype, "substation", void 0);
__decorate([
    property()
], SldSubstationEditor.prototype, "docVersion", void 0);
__decorate([
    property()
], SldSubstationEditor.prototype, "gridSize", void 0);
__decorate([
    property()
], SldSubstationEditor.prototype, "nsp", void 0);
__decorate([
    property()
], SldSubstationEditor.prototype, "resizingBR", void 0);
__decorate([
    property()
], SldSubstationEditor.prototype, "resizingTL", void 0);
__decorate([
    property()
], SldSubstationEditor.prototype, "placing", void 0);
__decorate([
    property()
], SldSubstationEditor.prototype, "placingOffset", void 0);
__decorate([
    property()
], SldSubstationEditor.prototype, "placingLabel", void 0);
__decorate([
    property()
], SldSubstationEditor.prototype, "connecting", void 0);
__decorate([
    property()
...
], SldSubstationEditor.prototype, "resizeSubstationUI", void 0);
__decorate([
    query('#substationWidthUI')
], SldSubstationEditor.prototype, "substationWidthUI", void 0);
__decorate([
    query('#substationHeightUI')
], SldSubstationEditor.prototype, "substationHeightUI", void 0);
__decorate([
    query('svg#sld')
], SldSubstationEditor.prototype, "sld", void 0);
__decorate([
    query('sld-snackbar')
], SldSubstationEditor.prototype, "groundHint", void 0);
__decorate([
    query('sld-context-menu')
], SldSubstationEditor.prototype, "contextMenu", void 0);
__decorate([
    state()
], SldSubstationEditor.prototype, "mouseX", void 0);
__decorate([
    state()
], SldSubstationEditor.prototype, "mouseY", void 0);
__decorate([
    state()
], SldSubstationEditor.prototype, "mouseX2", void 0);
__decorate([
    state()
], SldSubstationEditor.prototype, "mouseY2", void 0);
__decorate([
    state()
], SldSubstationEditor.prototype, "mouseX2f", void 0);
__decorate([
    state()
], SldSubstationEditor.prototype, "mouseY2f", void 0);
