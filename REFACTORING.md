...
- `npm run test` passed with `542 passed, 0 failed` (after deleting `SldEditor`'s five test-only/dead interaction getters and switching spec assertions to the `targetInMode` selector).
