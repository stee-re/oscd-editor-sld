function shiftPoint(point, rot, coord, amount) {
...
export function transformerWindingMeasures(winding, transformerPosition, { rot, kind, flip }, twoWindingEarthingZigZagTransform) {
