...
import { newResizeEvent, newResizeTLEvent, newPlaceEvent, newPlaceLabelEvent, newConnectEvent, newRotateEvent, newStartResizeTLEvent, newStartResizeBREvent, newStartPlaceEvent, newStartPlaceLabelEvent, newStartConnectEvent, newSelectEvent, newSclEditDialogEvent, newEditIedEvent, } from './events.js';
describe('events', () => {
    let element;
    beforeEach(() => {
